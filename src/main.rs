/*
 * This is not entirely my original work.
 * Some of this code has been copied and modified from the vulkano triangle example:
 * https://github.com/tomaka/vulkano
 * The original code contains the following notice:
 */
...
fn main() {
    ...
    mod vs { include!{concat!(env!("OUT_DIR"), "/shaders/src/asset/triangle_vs.glsl")} }
    let vs = vs::Shader::load(&device).expect("failed to create shader module");
    mod fs { include!{concat!(env!("OUT_DIR"), "/shaders/src/asset/triangle_fs.glsl")} }
